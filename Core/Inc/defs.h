...
//#define DEBUG /* Definition manuelle si l'environnement ne g�re pas l'option */
//#define WO_APP_RESET
...
//#define _LAB_   /* Laboratoire avec equipements RF non match�s ---> LABO */
//#define _RND_   /* R&D speciale avec equipements RF pre-match�s ----> NA */
/*----------------------------------------------------------------------------*/
#endif/*DEBUG*/

/* ATTENTION pdt la map avec equipements RF pre-match�s un chgt de FAV
...
//#define _FAVOLD_   /* Compil pour map avec Fav LCD � icones semi-graphique */
...
#define TOP_TIME_NDOFSWREL  15  /* XXs apres le dernier relach� */

/* Envoie une trame vers le PART 03s apr�s le dernier relach� */
#define RF_REFRESH03s  uiTIM01sRST_SAMPLE = TIM01sRST_REPEAT-3; 

/* Envoie une trame vers le PART XXs apr�s le dernier relach� */
...
#define TIMEOUT_TIM01sACT_INFO       5 // Timeout charg� � 5s.
#define TIMEOUT_TIM01sMST_UPDT      30 // Timeout charg� � 30s.
#define TIMEOUT_TIM01sWEB_UPDT       4 // Timeout charg� � 4s.
#define TIMEOUT_TIM1TSWEBMODIF       1 // Timeout charg� � 1TimeSlot.
...
#define TIMEOUT_TIM5msRUN_ACT_BY_AUTO TO_T5msRUNAUTOMAX // 3776 x  5ms 18,88s, pour 2x(4TX-RX + alea non acquitt�s).
#define TIMEOUT_TIM5msRUN_ACT_BY_INFO   200 //  200 x  5ms 1000ms.
#define TIMEOUT_TIM5msRUN_ACT_BY_WAIT    20 //   20 x  5ms  100ms.
#define TIMEOUT_TIM01sLIM_MODE       600 /* Timeout charg� � 600 */
#define RTC_HBKP      1  /* � 01hXX */
#define RTC_MBKP      5  /* � XXh05 */
#define RTC_SBKP      36 /* � XXhXX36s */

/* Param�tres installateur de la mesure de la CTN */
#define STEP01C      1 /* Step d'inc/dec � 0.1C� */
#define TABSOF7PRO  20 /* Temperature absolue maxi d'offset cad (-2.0�C � +2.0�C) */
...
#define SMCLK_X SMCLK_5 /* affichage des fenetres de SMCLK_0 � SMCLK_X */
...
/* Flags Transmis � la FAV et le WEB */
...
/*
Exemple de define d'un bit pour la trace au scope � action double INT/EXT ald d'un bit INT seul.
#define FLAG_ACT_MATC             LED_2//SFlags5.bit.b1
permet l'affichage au scope de l'activit� de la phase de matching.
*/
...
/*=== VARIABLES EXTERNES ==================================================*/
/* globales utilis�es par tout le monde */
typedef struct {
  uint8_t Var_01;
...
extern int16_t g_Text; /* Temperature exterieure initialis�e � SANS_Text */
...
extern uint8_t Rf_Level_Quality; /* niveau de r�ception radio de la face avant */
extern uint8_t Langue;  /* attention variable � peut-etre sauvegarder en virtual eeprom */
